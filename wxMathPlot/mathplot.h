...
class WXDLLIMPEXP_MATHPLOT mpWindow: public wxWindow
{
  ...
  protected:
    ...
    virtual void OnMouseLeftDoubleClick(wxMouseEvent &event);     //!< Mouse handler for the left button double click
    virtual void OnMouseRightDoubleClick(wxMouseEvent &event);    //!< Mouse handler for the right button double click
