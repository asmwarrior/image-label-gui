...
EVT_LEFT_DCLICK(mpWindow::OnMouseLeftDoubleClick) // Left mouse double-click
EVT_RIGHT_DCLICK(mpWindow::OnMouseRightDoubleClick) // Right mouse double-click
...
void mpWindow::OnMouseLeftDoubleClick(wxMouseEvent& event)
{
    if(CheckUserMouseAction(event))
        return;
    event.Skip();
...
void mpWindow::OnMouseRightDoubleClick(wxMouseEvent& event)
{
    if(CheckUserMouseAction(event))
        return;
    event.Skip();
